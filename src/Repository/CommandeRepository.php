...
class CommandeRepository extends ServiceEntityRepository
{
    ...
    {
        return $this->createQueryBuilder('t10')
            ->select('t10.creatAt, t10.prixTotal') // sélectionner les champs souhaités
            ->where('t10.user = :user') // remplacer "user" par le nom de champ approprié
